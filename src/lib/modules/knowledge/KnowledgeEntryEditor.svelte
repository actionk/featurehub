...
{#if entry}
  <div class="kb-editor">
    <div class="kb-editor-header">
      <input
        class="input kb-editor-title"
        bind:value={editTitle}
        oninput={scheduleSave}
        placeholder="Entry title"
      />
      <div class="kb-editor-toolbar">
        <button class="btn btn--sm" class:btn--primary={previewMode} class:active={previewMode} onclick={() => previewMode = !previewMode}>
          {previewMode ? "Edit" : "Preview"}
        </button>
        <button class="btn btn--sm btn--icon btn-danger" onclick={handleDelete} title="Delete entry">
    ...
    <input
      class="input kb-editor-description"
